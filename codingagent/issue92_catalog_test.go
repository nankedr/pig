...
func issue92SummaryCatalogEntry() catalog.Entry {
	return catalog.Entry{
		...
		Partial:   &catalog.Partial{Supported: []string{"public SDK branch-summary navigation: common ancestor, newest-first budget, prior summaries/compaction, file operations, custom/replace instructions, root/user/custom/assistant targets and summary labels", "Provider/ambient custom-stream auth, isolated no-cache summary requests, settings retry and summarization_retry events; AbortBranchSummary, IsCompacting, WaitForIdle and failure rollback", "v3 branch_summary persistence, SDK reopen, model-visible continuation, cross-branch roundtrip and same-leaf no-op preserve original branches; no-summary navigation remains covered by contract:codingagent/session-tree-navigation"}, Unsupported: []string{"extension session_before_tree/session_tree hooks, extension summary overrides/cancellation, TUI controls and later Provider Adapter paths remain deferred; RPC extension-context summary navigation belongs to M7 (#9), not M4 direct wire commands", "automatic compaction is covered by contract:codingagent/compaction; branch-summary queue draining remains deferred"}},
		Deviation: &catalog.Deviation{ADR: "docs/adr/0030-branch-summary-navigation.md", Reason: "Go context cancellation retains error identity; serialized admission and staged v3 replacement preserve state on storage failure."},
