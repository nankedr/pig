...
func issue84FindLsCatalogEntry() catalog.Entry {
	return catalog.Entry{
		...
		Deviation: &catalog.Deviation{ADR: "docs/adr/0023-find-ls-platform-contract.md", Reason: "Missing fd never triggers network or downloads. Go Operations use synchronous context-aware methods and integral FindGlobOptions.Limit. Error-details absence is normalized across the existing dispatcher mapping."},
