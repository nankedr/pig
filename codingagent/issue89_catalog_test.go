...
func issue89PromoteRuntimeEntry(entry *catalog.Entry) bool {
	...
	case "member:codingagent/src/core/agent-session.ts#AgentSession.compact", "member:codingagent/src/core/agent-session.ts#AgentSession.abortCompaction", "member:codingagent/src/core/agent-session.ts#AgentSession.isCompacting",
		...
		entry.Partial = &catalog.Partial{Supported: []string{"manual compaction through public AgentSession and typed SummaryOptions, v3 persistence and continuation; see contract:codingagent/compaction"}, Unsupported: []string{"automatic compaction, extension hooks, RPC/TUI controls and later Adapter paths remain deferred"}}
