...
func issue91TreeCatalogEntry() catalog.Entry {
	return catalog.Entry{
		...
		Deviation: &catalog.Deviation{ADR: "docs/adr/0026-session-tree-navigation.md", Reason: "Go context cancellation, complete-run exclusion and staged label writes strengthen failure atomicity without replacing Session resources."},
