...
func issue74ExtendProductEntry(t *testing.T, entry *catalog.Entry) {
	...
	entry.Partial.Supported = append(entry.Partial.Supported, "Issue #74: saved global Provider/model/thinking and Session paths drive Headless startup; project settings remain unread before the issue #75 trust gate")
