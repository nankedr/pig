...
M0 入口：[兼容骨架](learning/m0-compatibility-skeleton.md)与 [TypeScript 到 Go 导航](mappings/typescript-to-go/m0.md)。M1 Headless text/JSON 入口：[执行链与运行说明](learning/m1-headless-text.md)和 [TypeScript 到 Go 导航](mappings/typescript-to-go/m1-headless-text.md)。M2 已有 [thinking/signature](learning/m2-thinking-signatures.md)、[usage/cost/cache](learning/m2-usage-cost-cache.md)、[deferred response](learning/m2-deferred-response.md)、[deferred tools](learning/m2-deferred-tools.md) 和 [Telemetry](learning/m2-telemetry.md) 以及 [compat 与 Session Resource](learning/m2-compat-session-resources.md) 以及 [跨 Provider 消息 handoff](learning/m2-message-handoff.md) 七条可运行切片，对应导航见 [M2.1 mapping](mappings/typescript-to-go/m2-thinking-signatures.md)、[M2.2 mapping](mappings/typescript-to-go/m2-usage-cost-cache.md)、[M2.3 mapping](mappings/typescript-to-go/m2-deferred-response.md)、[M2.4 mapping](mappings/typescript-to-go/m2-deferred-tools.md) 、[M2.5 mapping](mappings/typescript-to-go/m2-telemetry.md) 和 [M2.6 mapping](mappings/typescript-to-go/m2-compat-session-resources.md) 和 [M2.7 mapping](mappings/typescript-to-go/m2-message-handoff.md)。
