...
M4/v0.4.0 的发布范围、安装、组合示例和验证制品见 [M4 集成与冻结](learning/m4-freeze.md)、[TypeScript → Go 导航](mappings/typescript-to-go/m4-freeze.md)及 [发布说明](releases/v0.4.0.md)。
...
- [M6.7 命令、本地资源与文件补全](learning/m6-autocomplete.md)
