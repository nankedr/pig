...
func TestPigThemesParity120(t *testing.T) {
	...
	cmd := exec.Command("python3", "../../parity/terminal/themes.py", binary, "--pig")
	data, err := cmd.Output()
	if err != nil {
	...
	fixture, err := parity.LoadFixture("../../parity/oracle/fixtures/themes-cli.json", locked)
	if err != nil {
		t.Fatal(err)
	}
