...
func TestPigInteractiveBranchesParity119(t *testing.T) {
	...
	cmd := exec.Command("python3", "../../parity/terminal/interactive-branches.py", binary, "--pig")
	data, err := cmd.Output()
	if err != nil {
	...
	fixture, err := parity.LoadFixture("../../parity/oracle/fixtures/interactive-branches-cli.json", locked)
	if err != nil {
		t.Fatal(err)
	}
