...
m0-oracle: m0-node-preflight
	...
	node --experimental-strip-types parity/oracle/edit-tool.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	node --experimental-strip-types parity/oracle/find-ls.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	node --experimental-strip-types parity/oracle/write-tool.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	node --experimental-strip-types parity/oracle/grep-tool.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	node --experimental-strip-types parity/oracle/bash-tool.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	...
	node --experimental-strip-types parity/oracle/local-extensions.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	...
	node --experimental-strip-types parity/oracle/prompt-templates.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	node --experimental-strip-types parity/oracle/system-prompts.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	...
	node --experimental-strip-types parity/oracle/session-bash.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	node --experimental-strip-types parity/oracle/session-configuration.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
	node --experimental-strip-types parity/oracle/auto-compaction.mjs "$(abspath $(PIG_PI_ORACLE_CHECKOUT))" --check
